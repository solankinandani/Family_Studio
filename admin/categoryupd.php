...
?>
<h1 class="head"> UpdateCategory</h1>
...
<?php
	...
	$q=mysqli_query($cn,"select * from category where id='$id'");
	echo "<form method='POST' action='categoryupdpro.php'>";
	while($r=mysqli_fetch_array($q))
	{
		echo "<input type='hidden' name='id' value=".$id.">";

		echo "<tr><td class='f1'><h2>Enter category:</h2></td>";
